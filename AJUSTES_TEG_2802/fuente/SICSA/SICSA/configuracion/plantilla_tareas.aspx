<%@ Page Title="Definición de Plantillas" Language="C#" MasterPageFile="~/portal/Main.master" AutoEventWireup="true" CodeBehind="plantilla_tareas.aspx.cs" Inherits="SICSA.configuracion.plantilla_tareas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxPageControl ID="ASPxPageTareas" runat="server" ActiveTabIndex="0" Width="100%">
        <TabPages>
                    ...
                    <dx:ContentControl runat="server">
                        ...
                        <dx:ASPxGridView ID="ASPxGridPlantilla" ClientInstanceName="ASPxGridPlantilla" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataPlantillas" KeyFieldName="CD_PLANTILLA" Width="100%">
                            <Columns>
                                ...
                                <dx:GridViewDataCheckColumn Caption="Habilitar" FieldName="ESTADO_PLANTILLA" ShowInCustomizationForm="True" VisibleIndex="4" Width="30px">
...
WHERE CD_EJE_DETA_PLANTILLA = @CD_EJE_DETA_PLANTILLA">
                        ...
                        |<dx:ASPxGridView ID="ASPxGridTareas" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataTareas" KeyFieldName="CD_EJE_DETA_PLANTILLA" Width="100%">
                            <Columns>
                                ...
                                <dx:GridViewDataCheckColumn Caption="Habilitar" FieldName="ESTADO_TAREA" ShowInCustomizationForm="True" VisibleIndex="9" Width="15px">
                                </dx:GridViewDataCheckColumn>
