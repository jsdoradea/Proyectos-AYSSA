...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxPageControl ID="ASPxPageInformes" runat="server" ActiveTabIndex="3" Width="100%">
        <TabPages>
            <dx:TabPage Text="Control">
                <ContentCollection>
...
where a.CD_RESPONSABLE=@CD_RESPONSABLE AND (a.FE_FECHA_INI BETWEEN @FECHA_INI and @FECHA_FIN ) ORDER BY a.CD_ENCA_ACUERDOS, a.NM_TAREA">
                                ...
                                <td colspan="6">
                                    ...
                                    <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" ClientIDMode="AutoID" DataSourceID="SqlDataEstados2" Width="100%">
                                        <Fields>
                                            ...
                                            <dx:PivotGridField Area="RowArea" AreaIndex="2" Caption="Acuerdo" FieldName="ACUERDO" Width="200">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField Area="RowArea" AreaIndex="3" Caption="N° Tarea" FieldName="NM_TAREA" Width="50">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField Area="RowArea" AreaIndex="4" Caption="Tarea" FieldName="DS_TAREA" Width="200">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField Area="RowArea" AreaIndex="5" Caption="Fecha Inicio" FieldName="FECHA_INI" CellFormat-FormatString="{0:dd-MM-yyyy}" CellFormat-FormatType="DateTime" Width="50">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField Area="RowArea" AreaIndex="6" Caption="Fecha Fin" FieldName="FECHA_FIN" CellFormat-FormatString="d" CellFormat-FormatType="DateTime" Width="50">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField Area="RowArea" AreaIndex="7" Caption="Plazo (días)" FieldName="DIAS_EJEC" Width="30">
                                            </dx:PivotGridField>
                                            ...
                                            <dx:PivotGridField ID="fieldDSACTA" Area="RowArea" AreaIndex="1" Caption="Acta" FieldName="DS_ACTA">
                                            </dx:PivotGridField>
                                        </Fields>
            ...
            <dx:TabPage Text="Seguimiento">
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        <asp:SqlDataSource ID="SqlDataPeriodos" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="SELECT [CD_CIERRE], [DS_PERIODO], [CD_EJERICIO] FROM [GLB_CIERRE_PERIODO] ORDER  BY [CD_EJERICIO] DESC, CD_PERIODO DESC"></asp:SqlDataSource>
                        <asp:SqlDataSource ID="SqlDataControl" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="vista_rep_estados_control_sp" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                        ...
                        <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridViewControl" FileName="Seguimiento">
                        </dx:ASPxGridViewExporter>
                        <table style="width:100%;">
                            <tr>
                                <td style="width:20%;">Periodo:</td>
                                <td>
                                    <dx:ASPxComboBox ID="ASPxComboBoxPeriodo" runat="server" DataSourceID="SqlDataPeriodos" ValueField="CD_CIERRE">
                                        <Columns>
                                ...
                                <td>
                                    <dx:ASPxButton ID="ASPxButton3" runat="server" OnClick="ASPxButton3_Click" Text="Generar Informe">
                                    </dx:ASPxButton>
                                </td>
                                <td align="right">
                                    <dx:ASPxButton ID="ASPxButton4" runat="server" Text="Exportar a Excel" OnClick="ASPxButton4_Click">
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <dx:ASPxPivotGrid ID="ASPxPivotGrid2" runat="server" DataSourceID="SqlDataControl" Width="100%" Visible="False">
                                        <Fields>
                                            <dx:PivotGridField ID="fieldDSACTA1" Area="RowArea" AreaIndex="0" Caption="Acta" FieldName="DS_ACTA">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldACUERDO" Area="RowArea" AreaIndex="1" Caption="Acuerdo" FieldName="ACUERDO">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldRESPONSABLE1" Area="RowArea" AreaIndex="2" Caption="Responsable" FieldName="RESPONSABLE">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldDSTAREA" Area="RowArea" AreaIndex="3" Caption="Tarea" FieldName="DS_TAREA">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldFEFECHAINI" Area="RowArea" AreaIndex="4" Caption="Fecha Inicio" FieldName="FE_FECHA_INI">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldFECHAFIN" Area="RowArea" AreaIndex="5" Caption="Fecha Fin" FieldName="FECHA_FIN">
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldROJOS1" Area="DataArea" AreaIndex="0" Caption="Retrasados" FieldName="ROJOS">
                                                <CellStyle BackColor="Red">
                                                </CellStyle>
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldAMARILLOS1" Area="DataArea" AreaIndex="1" Caption="Próximos a vencer" FieldName="AMARILLOS">
                                                <CellStyle BackColor="Yellow">
                                                </CellStyle>
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldVERDES1" Area="DataArea" AreaIndex="2" Caption="Al día" FieldName="VERDES">
                                                <CellStyle BackColor="Green">
                                                </CellStyle>
                                            </dx:PivotGridField>
                                            <dx:PivotGridField ID="fieldRESPONSABLE11" Area="DataArea" AreaIndex="3" Caption="Total" FieldName="RESPONSABLE" SummaryType="Count">
                                            </dx:PivotGridField>
                                        </Fields>
                                        <OptionsView RowTotalsLocation="Tree" />
                                        <OptionsData AutoExpandGroups="False" />
                                    </dx:ASPxPivotGrid>
                                    <dx:ASPxGridView ID="ASPxGridViewControl" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataControl" Width="100%">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Acuerdo" FieldName="ACUERDO" GroupIndex="0" ShowInCustomizationForm="True" SortIndex="0" SortOrder="Ascending" VisibleIndex="1">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Tarea" FieldName="DS_TAREA" ShowInCustomizationForm="True" VisibleIndex="6">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Dias" FieldName="DIAS_EJEC" ShowInCustomizationForm="True" VisibleIndex="8">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Responsable" FieldName="RESPONSABLE" ShowInCustomizationForm="True" VisibleIndex="7">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="VERDES" ShowInCustomizationForm="True" Visible="False" VisibleIndex="11">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="AMARILLOS" ShowInCustomizationForm="True" Visible="False" VisibleIndex="12">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="ROJOS" ShowInCustomizationForm="True" Visible="False" VisibleIndex="13">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Acta" FieldName="DS_ACTA" ShowInCustomizationForm="True" VisibleIndex="2">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataDateColumn Caption="Fecha de Acta" FieldName="FE_ACTA" ShowInCustomizationForm="True" VisibleIndex="3">
                                                <PropertiesDateEdit DisplayFormatString="">
                                                </PropertiesDateEdit>
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataTextColumn Caption="N° de Acuerdo" FieldName="N_ACUERDO" ShowInCustomizationForm="True" VisibleIndex="4">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Tipo de Acuerdo" FieldName="TIPO_ACU" ShowInCustomizationForm="True" VisibleIndex="5">
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                                        <Settings ShowFilterRow="True" ShowGroupPanel="True" />
                                        <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
