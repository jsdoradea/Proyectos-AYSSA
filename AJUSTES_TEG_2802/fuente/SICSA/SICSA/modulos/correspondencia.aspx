                                ...
                                <td colspan="3">
                                    <dx:ASPxGridView ID="ASPxGridDatosCorrespondencia" ClientInstanceName="ASPxGridDatosCorrespondencia" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataGridDatos" KeyFieldName="CD_AGENDA" Width="100%">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Unidad / Institución" FieldName="UNIDAD" ShowInCustomizationForm="True" VisibleIndex="9">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Persona" FieldName="SOLICITANTE" ShowInCustomizationForm="True" VisibleIndex="10" Width="200px">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataDateColumn Caption="Fecha de registro" FieldName="FECHA_REGISTRO" ShowInCustomizationForm="True" VisibleIndex="11">
                                            </dx:GridViewDataDateColumn>
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Origen" FieldName="ORIGEN" ShowInCustomizationForm="True" VisibleIndex="8">
                                                <PropertiesComboBox DataSourceID="SqlDataOrigenPunto" TextField="DS_ORIG_PUNTO" ValueField="CD_ORIG_PUNTO">
                                                </PropertiesComboBox>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewCommandColumn ButtonType="Button" Caption=" " ShowDeleteButton="True" ShowInCustomizationForm="True" VisibleIndex="12">
                                            </dx:GridViewCommandColumn>
                                            <dx:GridViewDataTextColumn Caption="Referencia del documento" FieldName="DS_REFERENCIA" ShowInCustomizationForm="True" VisibleIndex="4" Width="80px">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataDateColumn Caption="Fecha Documento" FieldName="FE_FECHA_DOC" ShowInCustomizationForm="True" VisibleIndex="5">
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataTextColumn Caption="Descripción" FieldName="DS_DESCRIPCION" ShowInCustomizationForm="True" VisibleIndex="7">
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
