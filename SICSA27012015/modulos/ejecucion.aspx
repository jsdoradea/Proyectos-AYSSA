...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="titulo">
        <h2>Relación y Notificación de Acuerdos Tomados</h2>
    </div>
    <dx:ASPxPageControl ID="ASPxPageAcuerdos" runat="server" ActiveTabIndex="1" Width="100%">
        <TabPages>
                                ...
                                <td colspan="2">
                                    <dx:ASPxGridView ID="ASPxGridAcuerdos" ClientInstanceName="ASPxGridAcuerdos" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataAcuerdos" KeyFieldName="CD_ENCA_ACUERDOS" Width="100%">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Referencia" FieldName="DS_REFERENCIA" ShowInCustomizationForm="True" VisibleIndex="3">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="N° Acuerdo" FieldName="NM_CORR_ACUERDO" ShowInCustomizationForm="True" VisibleIndex="4">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Acuerdo" FieldName="DS_ACUERDO_COMP" ShowInCustomizationForm="True" VisibleIndex="5">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataDateColumn Caption="Fecha de Inicio" FieldName="FE_FECHA_INI" ShowInCustomizationForm="True" VisibleIndex="7">
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataTextColumn Caption="Periodo (días)" FieldName="PERIODO_DIAS" ShowInCustomizationForm="True" VisibleIndex="8">
                                                <HeaderStyle HorizontalAlign="Right" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Responsable" FieldName="RESPONSABLE" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="9">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataImageColumn Caption="Estado" FieldName="url_imagen" ShowInCustomizationForm="True" VisibleIndex="10">
                                                <PropertiesImage ImageAlign="Middle" ImageHeight="30px" ImageWidth="30px">
                                                </PropertiesImage>
                                            </dx:GridViewDataImageColumn>
                                            <dx:GridViewDataComboBoxColumn Caption="Tipo de Acuerdo" FieldName="CD_TIPO_ACUERDO" ShowInCustomizationForm="True" VisibleIndex="6">
                                                <PropertiesComboBox DataSourceID="SqlDataTipoAcuerdo" TextField="DS_TIPO_ACUERDO" ValueField="CD_TIPO_ACUERDO">
                                                </PropertiesComboBox>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataTextColumn Caption="CD_ENCA_CONVOCATORIA" FieldName="CD_ENCA_CONVOCATORIA" ShowInCustomizationForm="True" Visible="False" VisibleIndex="11">
                                            </dx:GridViewDataTextColumn>
                                        </Columns>
                    ...
                    <dx:ContentControl runat="server">
                        <table style="width:100%;">
                            <tr>
                                <td>Sesión:</td>
                                <td>
                                    <asp:TextBox ID="TextBoxSesion" runat="server" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td>Acta:</td>
                                <td>
                                    <asp:TextBox ID="TextBoxActa" runat="server" ReadOnly="True"></asp:TextBox>
                                </td>
                                <td>Acuerdo N°:</td>
                                <td>
                                    <asp:TextBox ID="TextBoxNumAcuerdo" runat="server" ReadOnly="True" Width="60px"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">Días Ejec. Establecidos:</td>
                                <td style="text-align: right;">
                                    <asp:TextBox ID="TextBoxDias" runat="server" ReadOnly="True" TextMode="Number" Width="40px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>Acuerdo:</td>
                                <td colspan="3">
                                    <dx:ASPxMemo ID="ASPxMemoAcuerdo" runat="server" Rows="2" Width="98%" ReadOnly="True">
                                    </dx:ASPxMemo>
                                </td>
                                <td>Fecha de Inicio:</td>
                                <td>
                                    <asp:TextBox ID="txtF_INI_ACU" runat="server" ReadOnly="True" TextMode="Date"></asp:TextBox>
                                </td>
                                <td style="text-align: right;">Fecha Fin:</td>
                                <td style="text-align: right;">
                                    <asp:TextBox ID="txtF_FIN_ACU" runat="server" ReadOnly="True" TextMode="Date"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td colspan="2">Tareas o actividades:</td>
                                <td>
                                    <dx:ASPxButton ID="ASPxButtonNuevaTarea" runat="server" OnClick="ASPxButtonNuevaTarea_Click" Text="Nueva tarea">
                                    </dx:ASPxButton>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>
                                    <asp:SqlDataSource ID="SqlDataTareas" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="tareas_vista_sp" SelectCommandType="StoredProcedure" DeleteCommand="DELETE FROM dbo.ACU_TAREAS_ACUERDOS WHERE CD_TAREA = @CD_TAREA">
                                        <DeleteParameters>
                                        ...
                                        <PanelCollection>
                                            <dx:PanelContent ID="PanelContent2" runat="server">
                                                <dx:ASPxGridView ID="ASPxGridTareas" ClientInstanceName="ASPxGridTareas" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataTareas" KeyFieldName="CD_TAREA" Width="100%">
                                                    <Columns>
                                                        <dx:GridViewCommandColumn Caption=" " ShowDeleteButton="True" ShowInCustomizationForm="True" VisibleIndex="12">
                                    ...
                                    <dx:ASPxPanel ID="ASPxPanelInfo" runat="server" Width="100%" Visible="False">
                                        <PanelCollection>
                                            <dx:PanelContent ID="PanelContent1" runat="server">
                                                <table style="width:100%;">
                                                    <tr>
                                                        <td class="auto-style1">Nombre de tarea:</td>
