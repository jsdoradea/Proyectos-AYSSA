<%@ Page Title="" Language="C#" MasterPageFile="~/portal/Main.master" AutoEventWireup="true" CodeBehind="control_actividades.aspx.cs" Inherits="SICSA.modulos.control_actividades" %>
...
WHERE a.ESTADO_TAREA = 2 and (a.AUTORIZADO =0 OR a.AUTORIZADO is null)"></asp:SqlDataSource>
                        ...
                        <table style="width:100%">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxRadioButtonList ID="ASPxRadioButtonList1" runat="server" Enabled="False" RepeatDirection="Horizontal" SelectedIndex="0" ValueType="System.Int32">
                                        <Items>
                                            <dx:ListEditItem Selected="True" Text="Aprobada" Value="1" />
                                            <dx:ListEditItem Text="Observada" Value="2" />
                            ...
                            <tr>
                                <td>Comentarios (Observación&nbsp; / Rechazo):</td>
                                <td>
