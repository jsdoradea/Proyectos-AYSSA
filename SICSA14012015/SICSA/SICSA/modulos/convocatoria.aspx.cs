...
namespace SICSA.correspondencia
{
    public partial class convocatoria : System.Web.UI.Page
    {
        ...
        protected void ASPxButtonAgregar_Click(object sender, EventArgs e)
        {
            ...
            manto_correspondencia.nuevo("n", cod_agenda, txtPunto.Text, txtJust.Text, Convert.ToInt32(ASPxRadioButtonListTipo.Value), Convert.ToInt32(ASPxComboBoxOrigen.Value), Convert.ToInt32(ASPxComboBoxSolicitantes.SelectedItem.Value), 1, Convert.ToDateTime(TextBoxFecha_Solicitud.Text), Convert.ToDateTime(TextBoxFecha_Registro.Text), Convert.ToInt32(Session["UserID"]));
            ASPxGridPuntos.DataBind();
            ASPxPageSesion.ActiveTabIndex = 1;
        }
    }
