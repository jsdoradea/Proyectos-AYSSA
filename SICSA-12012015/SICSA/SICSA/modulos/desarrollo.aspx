                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td colspan="2" style="max-width: 800px;">
                                    <dx:ASPxPageControl ID="ASPxPagePuntosDesarrollo" runat="server" ActiveTabIndex="3" Width="100%">
                                        <TabPages>
                                            <dx:TabPage Text="Quorum">
                                                <ContentCollection>
                                                    <dx:ContentControl runat="server">
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                <td>Miembros no Convocados<asp:SqlDataSource ID="SqlDataNoConvocados" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="SELECT DISTINCT a.CD_MIEMBRO_PLENO, c.DS_NOMBRE_EMPLEADO + ' ' + c.DS_APELLIDO_EMPLEADO AS MIEMBRO, d.DS_TIPO_MIEMBRO
...
WHERE X.CD_MIEMBRO_PLENO is null">
                                                                ...
                                                                <td>&nbsp;</td>
                                                                <td>miembros de Pleno presentes<asp:SqlDataSource ID="SqlDataConvocados" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="SELECT a.CD_MIEMBRO_PLENO, c.DS_NOMBRE_EMPLEADO + ' ' + c.DS_APELLIDO_EMPLEADO AS MIEMBRO, d.DS_TIPO_MIEMBRO
                                                ...
                                                <ContentCollection>
                                                    <dx:ContentControl runat="server">
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                <td style="vertical-align: top; width: 40%">
                                                                    <asp:SqlDataSource ID="SqlDataPuntosAgenda" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="SELECT a.CD_CONVOCATORIA, a.ORDEN, b.DS_PUNTO_AGENDA, c.DS_TIPO_INCLUSION
                                                                        ...
                                                                        <PanelCollection>
                                                                            <dx:PanelContent ID="PanelContent1" runat="server">
                                                                                <dx:ASPxGridView ID="ASPxGridPuntos" runat="server" ClientInstanceName="ASPxGridPuntos" AutoGenerateColumns="False" DataSourceID="SqlDataPuntosAgenda" Width="100%" KeyFieldName="CD_CONVOCATORIA">
                                                                                    ...
                                                                                    <Columns>
                                                                                        <dx:GridViewDataTextColumn FieldName="CD_CONVOCATORIA" ShowInCustomizationForm="True" VisibleIndex="0" ReadOnly="True" Visible="False">
                                                                                            <EditFormSettings Visible="False" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataCheckColumn Name="Select" ShowInCustomizationForm="False" VisibleIndex="1" Caption=" ">
                                                                                            <PropertiesCheckEdit DisplayFormatString="{0}" ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Caption="Orden" FieldName="ORDEN" ShowInCustomizationForm="True" VisibleIndex="2">
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataTextColumn Caption="Punto sugerido de Agenda" FieldName="DS_PUNTO_AGENDA" ShowInCustomizationForm="True" VisibleIndex="3">
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataTextColumn Caption="Incluido como:" FieldName="DS_TIPO_INCLUSION" ShowInCustomizationForm="True" VisibleIndex="4">
                                                                                        </dx:GridViewDataTextColumn>
                                                                                    </Columns>
                                                                                                                                                    ...
                                                                                                                                                    <table style="width: 100%;">
                                                                                                                                                        <tr>
                                                                                                                                                            <td style="width: 60%">
                                                                                                                                                                <table style="width: 100%;">
                                                                                                                                                                    <tr>
                                                                                                                                                                        <td style="width: 100px">Notifíquese a:<asp:SqlDataSource ID="SqlDataEmpleados" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="  SELECT a.CD_EMPLEADO, a.DS_NOMBRE_EMPLEADO + ' ' + a.DS_APELLIDO_EMPLEADO as EMPLEADO, b.DS_UNIDAD
...
ORDER BY b.DS_UNIDAD,  a.DS_NOMBRE_EMPLEADO, a.DS_APELLIDO_EMPLEADO"></asp:SqlDataSource>
                                                                                                                                                                        ...
                                                                                                                                                                        <td>
                                                                                                                                                                            <dx:ASPxComboBox ID="ASPxComboEmpleados" runat="server" DataSourceID="SqlDataEmpleados" Width="95%" Enabled="False" ValueField="CD_EMPLEADO">
                                                                                                                                                                                <Columns>
                                                                                                                                                                        ...
                                                                                                                                                                        <td>
                                                                                                                                                                            <table style="width: 100%">
                                                                                                                                                                                <tr>
                                                                                                                                                                                    ...
                                                                                                                                                                                    <td>
                                                                                                                                                                                        <dx:ASPxButton ID="ASPxButtonNotificar" runat="server" Text="Notificar" Enabled="False" OnClick="ASPxButtonNotificar_Click">
                                                                                                                                                                                        </dx:ASPxButton>
                                                                                                                                                                                    </td>
                                                                                                                                                                                </tr>
                                                                                                                                                                            </table>
                                                                                                                                                                    ...
                                                                                                                                                                    <tr>
                                                                                                                                                                        ...
                                                                                                                                                                        <td>
                                                                                                                                                                            <asp:SqlDataSource ID="SqlDataNotificacionAcuerdo" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" SelectCommand="  SELECT a.CD_ACU_NOTIFICACION, b.DS_NOMBRE_EMPLEADO + ' ' + b.DS_APELLIDO_EMPLEADO AS EMPLEADO, c.DS_CALIDAD_ACU
  ...
  WHERE CD_ENCA_ACUERDO= @CD_ENCA_ACUERDO" DeleteCommand="  DELETE FROM dbo.ACU_NOTIFICACION_ACUERDO WHERE CD_ACU_NOTIFICACION=@CD_ACU_NOTIFICACION">
                                                                                                                                                                                <DeleteParameters>
  ...
  WHERE CD_ENCA_CONVOCATORIA = @CD_ENCA_CONVOCATORIA">
                                                                                                                                                                ...
                                                                                                                                                                &nbsp;&nbsp; 
                                                                                                                                                                &nbsp;&nbsp; 
                                                                                                                                                                <dx:ASPxButton ID="ASPxButtonTerminarVotacion" runat="server" Text="Terminar Votación" OnClick="ASPxButtonTerminarVotacion_Click" Enabled="False">
                                                                                                                                                                </dx:ASPxButton>
                                                                                                                                                            </td>
                                                                                                                                                        </tr>
                                                                                                                                                        <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            ...
                                                                                            <dx:ASPxLabel ID="ASPxLabelAccionVoto" runat="server">
                                                                                            </dx:ASPxLabel>
                                                                                        </td>
                                                                                        <td colspan="2" style="text-align: right">
                                                                            ...
                                                                            <dx:PanelContent runat="server">
                                                                                <table style="width:100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>&nbsp;</td>
                                                                                        <td>
                                                                                            <dx:ASPxButton ID="ASPxButtonGenDocSesion" runat="server" OnClick="ASPxButtonGenDocSesion_Click" Text="Generar Documentación" Width="200px">
                                                                                            </dx:ASPxButton>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
