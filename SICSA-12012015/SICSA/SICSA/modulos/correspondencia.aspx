<%@ Page Title="" Language="C#" MasterPageFile="~/portal/Main.master" AutoEventWireup="true" CodeBehind="correspondencia.aspx.cs" Inherits="SICSA.correspondencia.correspondencia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="titulo">
        <h2>Registro de correspondencia normal y puntos de sesión</h2>
    </div>
    ...
    <dx:ASPxPageControl ID="PagerCorrespondencia" runat="server" ActiveTabIndex="1" Width="100%">
        <TabPages>
                ...
                <ContentCollection>
                    <dx:ContentControl runat="server">
                        <table style="width:100%">
                            <tr>
                                <td style="width:10%;"><label>Periodo:</label></td>
                                <td><dx:ASPxComboBox ID="ASPxComboBoxPeriodo" runat="server" ValueType="System.String" DataSourceID="SqlDataPeriodo" ValueField="CD_CIERRE" AutoPostBack="True">
                                    <Columns>
                            ...
                            <tr>
                                <td colspan="3">
                                    <dx:ASPxGridView ID="ASPxGridDatosCorrespondencia" ClientInstanceName="ASPxGridDatosCorrespondencia" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataGridDatos" KeyFieldName="CD_AGENDA" Width="100%">
                                        <Columns>
                                            <dx:GridViewDataTextColumn FieldName="CD_AGENDA" ShowInCustomizationForm="False" Visible="False" VisibleIndex="1">
                                            ...
                                            <dx:GridViewDataDateColumn Caption="Fecha recepción" FieldName="FECHA_RECEPCION" ShowInCustomizationForm="True" VisibleIndex="4">
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataTextColumn Caption="Concepto" FieldName="CONCEPTO" ShowInCustomizationForm="True" VisibleIndex="5">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Unidad / Institución" FieldName="UNIDAD" ShowInCustomizationForm="True" VisibleIndex="7">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Persona" FieldName="SOLICITANTE" ShowInCustomizationForm="True" VisibleIndex="8">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataDateColumn Caption="Fecha de registro" FieldName="FECHA_REGISTRO" ShowInCustomizationForm="True" VisibleIndex="9">
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataComboBoxColumn Caption="Tipo" FieldName="TIPO_C" ShowInCustomizationForm="True" VisibleIndex="3">
                                                <PropertiesComboBox DataSourceID="SqlDataTipoC" TextField="DS_TIPO_CORRES" ValueField="CD_TIPO_CORRES">
                                                </PropertiesComboBox>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataComboBoxColumn Caption="Origen" FieldName="ORIGEN" ShowInCustomizationForm="True" VisibleIndex="6">
                                                <PropertiesComboBox DataSourceID="SqlDataOrigenPunto" TextField="DS_ORIG_PUNTO" ValueField="CD_ORIG_PUNTO">
                                                </PropertiesComboBox>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewCommandColumn ButtonType="Button" Caption=" " ShowDeleteButton="True" ShowInCustomizationForm="True" VisibleIndex="10">
                    ...
                    <dx:ContentControl runat="server">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="ASPxComboBoxEstado" runat="server" ValueType="System.Int32" DataSourceID="SqlDataEstado" TextField="DS_ESTADO" ValueField="CD_ESTADO_CORR"></dx:ASPxComboBox>
                                </td>
                                <td style="text-align:right;">
                                    ...
                                    <div id="form_reg" style="border-style: solid; border-width: 1px; width:99%;">
                                        <table class="tabla">
                                            <tr>
                                                ...
                                                <td class="c3">
                                                    <label>Tipo de Correspondencia:</label></td>
                                            </tr>
                                            <tr>
                                                <td class="c1">
                                                    <label>Origen de Solicitud:</label></td>
                                                <td class="c2">
                                                    <dx:ASPxComboBox ID="ASPxComboBoxOrigen" runat="server" ValueType="System.Int32" DataSourceID="SqlDataOrigenPunto" TextField="DS_ORIG_PUNTO" ValueField="CD_ORIG_PUNTO" AutoPostBack="True" ></dx:ASPxComboBox>
                                                </td>
