    ...
    public class conv_puntos
    {
        public static List<datos_conv_puntos> datos_conv_puntos(int cd_punto)
        {
            ...
            using (SqlConnection _conn = conexion.conectarBD())
            {
                ...
                strquery = "SELECT b.DS_PUNTO_AGENDA, b.DS_JUSTIFICA, a.CD_TIPO_PUNTO, b.CD_ORIG_PUNTO, b.CD_UNIDAD_INSTITUCION FROM CONV_PUNTOS_AGENDA a 	INNER JOIN dbo.AGD_PUNTOS_AGENDA b ON b.CD_PUNTO_AGENDA = a.CD_PUNTO_AGENDA WHERE a.CD_CONVOCATORIA=" + cd_punto;
