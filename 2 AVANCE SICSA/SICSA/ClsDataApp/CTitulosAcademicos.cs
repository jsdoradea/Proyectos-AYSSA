...
namespace SIS.Data
{
    public class CTitulosAcademicos:CTemplate
    {
        private string _ConexionData;


        public CTitulosAcademicos(string ConexionData)
        {
        ...
        public ClsDataSets.DS_GLB_SIS Detalle(int CodigoCargo, string DescripcionCargo, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("PRAL_DATA_GLB_TITULOS_ACADEMICOS", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@CD_TITULO", CodigoCargo);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_TITULO", DescripcionCargo);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@OPCI_CONS", OpcionConsulta);


                ObjAdapter.Fill(objDataSet, "GLB_TITULOS_ACADEMICOS");
