<%@ Page Title="Desarrollo de Sesión" Language="C#" MasterPageFile="~/portal/Main.master" AutoEventWireup="true" CodeBehind="desarrollo.aspx.cs" Inherits="SICSA.modulos.desarrollo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Header1" runat="server">
    <script type="text/javascript">
        ...
        function OnRowClick5(e) {
            //Unselect all rows
            ASPxGridViewRepAcuerdos._selectAllRowsOnPage(false);
            //Select the row
            ASPxGridViewRepAcuerdos.SelectRow(e.visibleIndex, true);
            //alert('hola');
        }
    </script>
                                                                                                                            ...
                                                                                                                            <dx:ASPxPanel ID="ASPxPanel3" runat="server" Height="290px" Width="100%" Paddings-Padding="1px">
                                                                                                                                ...
                                                                                                                                <PanelCollection>
                                                                                                                                    <dx:PanelContent runat="server">
                                                                                                                                        ...
                                                                                                                                        <asp:SqlDataSource ID="SqlDataAcuerdos" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" DeleteCommand="UPDATE dbo.ACU_ENCA_ACUERDOS SET CD_ESTADO = 0 WHERE CD_ENCA_ACUERDOS = @CD_ENCA_ACUERDOS" SelectCommand="select CD_ENCA_ACUERDOS, NM_CORR_ACUERDO , DS_ACUERDO_COMP from dbo.ACU_ENCA_ACUERDOS  WHERE CD_DETA_CONV=@COD_CONV  and CD_ESTADO = 1 ORDER BY NM_CORR_ACUERDO  DESC">
                                                                                                                                            <DeleteParameters>
...
WHERE a.CD_ENCA_CONVOCATORIA=@CD_ENCA_CONVOCATORIA  and c.CD_ESTADO=1
ORDER BY a.ORDEN DESC">
                                                                                            ...
                                                                                            <dx:ASPxGridView ID="ASPxGridViewRepAcuerdos" ClientInstanceName="ASPxGridViewRepAcuerdos" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataRepAcuerdos" KeyFieldName="CD_ENCA_ACUERDOS" Width="98%">
                                                                                                <Columns>
                                                                                                    <dx:GridViewDataCheckColumn Name="Select" ShowInCustomizationForm="False" VisibleIndex="3" Caption=" ">
                                                                                                        <PropertiesCheckEdit DisplayFormatString="{0}" ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                                                                        </PropertiesCheckEdit>
                                                                                                        <DataItemTemplate>
                                                                                                            <dx:ASPxButton ID="btnVerDoc" runat="server" CommandArgument='<%# Eval("CD_ENCA_ACUERDOS") %>' OnClick="btnVerDoc_Click" Text="Generar Documento y Notificar Acuerdo" Wrap="True" />
                                                                                                        </DataItemTemplate>
                                                                                                    </dx:GridViewDataCheckColumn>
                                                                                                    ...
                                                                                                    <dx:GridViewDataTextColumn Caption="N° Punto de Agenda" FieldName="N_PUNTO_AGENDA" GroupIndex="0" ReadOnly="True" ShowInCustomizationForm="True" SortIndex="0" SortOrder="Ascending" VisibleIndex="4">
                                                                                                    </dx:GridViewDataTextColumn>
                                                                                                    <dx:GridViewDataTextColumn Caption="Punto de Agenda" FieldName="DS_PUNTO_AGENDA" ShowInCustomizationForm="True" VisibleIndex="5">
                                                                                                    </dx:GridViewDataTextColumn>
                                                                                                    <dx:GridViewDataTextColumn Caption="N° Acuerdo" FieldName="NM_CORR_ACUERDO" ShowInCustomizationForm="True" VisibleIndex="6">
                                                                                                    </dx:GridViewDataTextColumn>
                                                                                                    <dx:GridViewDataTextColumn Caption="Acuerdo" FieldName="DS_ACUERDO_COMP" ShowInCustomizationForm="True" VisibleIndex="7">
                                                                                                    </dx:GridViewDataTextColumn>
                                                                                                ...
                                                                                                <ClientSideEvents RowClick="function(s, e) { OnRowClick5(e); }">
                                                                                                </ClientSideEvents>
                                                                                            ...
                                                                                            <br />
                                                                                            <dx:ASPxButton ID="ASPxButtonGenRep" runat="server" Text="Generar y Notificar Toda la Documentación" OnClick="ASPxButtonGenRep_Click" Visible="False">
                                                                                            </dx:ASPxButton>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
