...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxPageControl ID="ASPxPageActividades" runat="server" ActiveTabIndex="0" Width="100%">
        <TabPages>
...
WHERE a.CD_TAREA=@CD_TAREA">
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxTextBox ID="ASPxTextBoxSesion" runat="server" Width="170px" ReadOnly="True">
                                        <ReadOnlyStyle BackColor="#FFFF66">
                                        </ReadOnlyStyle>
                                    </dx:ASPxTextBox>
                                </td>
                                <td>Acta:</td>
                            ...
                            <tr>
                                <td>Tarea:</td>
                                <td>
                                    <dx:ASPxMemo ID="ASPxMemoTarea" runat="server" Rows="2" Width="90%" ReadOnly="True" Font-Bold="True" Font-Size="Medium">
                                        <ReadOnlyStyle BackColor="#FFFF66">
                                        </ReadOnlyStyle>
                                    </dx:ASPxMemo>
                                </td>
                                <td>Fecha Incio:</td>
                                <td>
                                    <asp:TextBox ID="TextBoxFE_INI" runat="server" TextMode="Date" ReadOnly="True" BackColor="#FFFF66"></asp:TextBox>
                                </td>
                                <td>Fecha Fin:</td>
                                <td>
                                    <asp:TextBox ID="TextBoxFE_FIN" runat="server" TextMode="Date" ReadOnly="True" BackColor="#FFFF66"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                ...
                                <td>
                                    <asp:TextBox ID="TextBoxDiasEJE" runat="server" ReadOnly="True" BackColor="#FFFF66"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <dx:ASPxMemo ID="ASPxMemoDesc" runat="server" ReadOnly="True" Rows="3" Visible="False" Width="90%">
                                        <ReadOnlyStyle BackColor="#FFFF66">
                                        </ReadOnlyStyle>
                                    </dx:ASPxMemo>
                                </td>
