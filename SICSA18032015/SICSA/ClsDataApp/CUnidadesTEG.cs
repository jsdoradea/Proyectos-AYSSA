...
namespace SIS.Data
{
    public class CUnidadesTEG:CTemplate
    {
        private string _ConexionData;


        public CUnidadesTEG(string ConexionData)
        {
            _ConexionData = ConexionData;
        }

        public ClsDataSets.DS_GLB_SIS Detalle(int CodigoUnidad, string DescripcionUnidad, int OpcionConsulta)
        {
            ...
            try
            {
                ...
                ObjAdapter = new SqlDataAdapter("PRAL_DATA_GLB_UNIDADES_TEG", ObjConnection);
                ObjParam = new SqlParameter();
                ObjAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;

                ObjAdapter.SelectCommand.Parameters.AddWithValue("@CD_UNIDAD", CodigoUnidad);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@DS_UNIDAD", DescripcionUnidad);
                ObjAdapter.SelectCommand.Parameters.AddWithValue("@OPCI_CONS", OpcionConsulta);


                ObjAdapter.Fill(objDataSet, "GLB_UNIDADES_TEG");
            ...
            try
            {
                ...
                switch (OpcionActualizacion)
                {
                    case TipoActualizacion.Adicionar:
                        StrCommand = "PRAL_INSE_GLB_UNIDADES_TEG";
                        break;
                    case TipoActualizacion.Actualizar:
                        StrCommand = "PRAL_ACTU_GLB_UNIDADES_TEG";
                        break;
                    case TipoActualizacion.Eliminar:
                        StrCommand = "PRAL_ELIM_GLB_UNIDADES_TEG";
                        break;
