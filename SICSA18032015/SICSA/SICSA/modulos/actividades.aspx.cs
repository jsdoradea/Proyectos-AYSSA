    ...
    public partial class actividades : System.Web.UI.Page
    {
        ...
        protected void ASPxButton1_Click(object sender, EventArgs e)
        {
            ...
            if (guardar == true)
            {
                ...
                //Enviar notificación por correo a responsable y a el usuario que reporta.
                manto_tareas.enviar_correo(Convert.ToInt32(Session["UserID"].ToString()), Convert.ToInt32(ASPxLabelCodTarea.Text), Convert.ToInt32(ASPxRadioButtonList1.Value), ASPxMemo4.Text);
                string script = "alert('¡El registro se ha guardado y se ha enviado por correo!');";
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Aviso", script, true);
            }
            else
            {
