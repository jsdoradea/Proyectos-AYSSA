...
namespace SICSA.clases
{
    ...
    public class manto_ejecucion
    {
        ...
        public static void enviar_correo(int usuario, int cd_acu_enca)
        {
            using (System.Data.SqlClient.SqlConnection con = conexion.conectarBD())
            {
                SqlCommand Com = new SqlCommand();
                ...
                Com.Connection = con;
                Com.CommandType = CommandType.StoredProcedure;
                Com.CommandText = "envio_tareas_plan_SP";

                Com.Parameters.Add(new SqlParameter("@USUARIO", SqlDbType.Int));
                Com.Parameters["@USUARIO"].Value = usuario;
                Com.Parameters.Add(new SqlParameter("@CD_ACU_ENCA", SqlDbType.Int));
                Com.Parameters["@CD_ACU_ENCA"].Value = cd_acu_enca;
