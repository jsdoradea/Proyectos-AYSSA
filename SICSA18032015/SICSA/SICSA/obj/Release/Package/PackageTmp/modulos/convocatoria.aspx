<%@ Page Title="Convocatoria" Language="C#" MasterPageFile="~/portal/Main.master" AutoEventWireup="true" CodeBehind="convocatoria.aspx.cs" Inherits="SICSA.correspondencia.convocatoria" %>
                                ...
                                <td colspan="3">
                                    <dx:ASPxGridView ID="ASPxGridConvocatoria" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataGridDatos" KeyFieldName="CD_ENCA_CONVOCATORIA" ClientInstanceName="ASPxGridDatosConvocatoria" Width="100%">
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Clase" FieldName="TIPO_SESION" ShowInCustomizationForm="True" VisibleIndex="3">
                                            </dx:GridViewDataTextColumn>
                            ...
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td colspan="2" style="max-width: 800px;">
                                        <dx:ASPxPageControl ID="ASPxPageSesion" runat="server" ActiveTabIndex="3" Width="100%" OnActiveTabChanged="ASPxPageSesion_ActiveTabChanged" AutoPostBack="True">
                                            <TabPages>
                                                    ...
                                                    <ContentCollection>
                                                        <dx:ContentControl ID="ContentControl1" runat="server">
                                                            <table style="width: 100%">
                                                                ...
                                                                <tr>
                                                                    <td>C<label>lase de sesión:</label></td>
                                                                    <td>
                                                ...
                                                <dx:TabPage Name="Puntos" Text="Selección de puntos">
                                                    <ContentCollection>
                                                        <dx:ContentControl ID="ContentControl2" runat="server">
                                                            ...
                                                            <dx:ASPxGridView ID="ASPxGridPuntos" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataPuntos" Width="100%" KeyFieldName="CD_PUNTO_AGENDA">
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataComboBoxColumn Caption="Estado" FieldName="CD_TIPO_INCLUSION" ShowInCustomizationForm="True" VisibleIndex="6">
...
WHERE NOT(a.CD_ESTADO_CORR = 2 OR a.CD_ESTADO_CORR=3) and CD_TIPO_CORRESP = 2
ORDER BY a.FE_FECH_SOLIC, a.CD_PUNTO_AGENDA"
                                                                UpdateCommand="EXEC	dbo.puntos_convocatoria_sp 	@COD_AGENDA = @CD_PUNTO_AGENDA,  @COD_TIPO_INCLUSION = @CD_TIPO_INCLUSION,  @COD_ENCA_CONV = @CD_ENCA_CONVOCATORIA">
                                                                <SelectParameters>
                                                                    <asp:ControlParameter ControlID="lblConvocatoria" DefaultValue="" Name="CD_CONV" PropertyName="Text" />
                                                                </SelectParameters>
                                                                <UpdateParameters>
...
ORDER BY a.ORDEN">
                                                                                <SelectParameters>
                                                                                    <asp:ControlParameter ControlID="lblConvocatoria" DefaultValue="" Name="CD_ENCA_CONVOCATORIA" PropertyName="Text" />
                                                                                </SelectParameters>
                                                                            </asp:SqlDataSource>
                                                                            <table style="width: 100%">
                                                                                <tr>
                                                                                    <td style="text-align: center;">
                                                                                        <dx:ASPxGridView ID="GridPuntosAgenda" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataPuntosIncluidos" KeyFieldName="CD_CONVOCATORIA" Width="100%">
                                                                                            <Columns>
                                                                                                ...
                                                                                                <dx:GridViewDataTextColumn Caption="Estado" FieldName="DS_TIPO_INCLUSION" ShowInCustomizationForm="True" VisibleIndex="3">
                                                                                                </dx:GridViewDataTextColumn>
                                                ...
                                                <dx:TabPage Name="Convocatoria" Text="Convocatoria">
                                                    <ContentCollection>
...
WHERE a.CD_ESTADO = 1
ORDER BY a.CD_TIPO, a.JERARQUIA, b.DS_NOMBRE_EMPLEADO, b.DS_APELLIDO_EMPLEADO"></asp:SqlDataSource>
                                                                        <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server" AutoPostBack="True" CheckState="Unchecked" OnCheckedChanged="ASPxCheckBox1_CheckedChanged" Text="Todos los Miembros Propietarios">
                                                                        </dx:ASPxCheckBox>
                                                                                ...
                                                                                <dx:PanelContent ID="PanelContent1" runat="server">
                                                                                    <dx:ASPxGridView ID="ASPxGridViewMiembrosPleno" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataMiembros" KeyFieldName="CD_MIEMBRO_PLENO" Width="100%">
                                                                                        <Columns>
                                                                                            ...
                                                                                            <dx:GridViewDataTextColumn Caption="Miembro del pleno" FieldName="EMPLEADO" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="2">
                                                                                            </dx:GridViewDataTextColumn>
