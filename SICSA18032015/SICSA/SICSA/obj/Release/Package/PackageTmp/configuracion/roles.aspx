<%@ Page Title="Roles y Permisos" Language="C#" MasterPageFile="~/portal/Main.master" AutoEventWireup="true" CodeBehind="roles.aspx.cs" Inherits="SICSA.configuracion.roles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataRoles" runat="server" ConnectionString="<%$ ConnectionStrings:SICSA %>" InsertCommand="INSERT INTO dbo.CONF_ROL (rol, descripcion, estado) VALUES (@rol, @descripcion, @estado)
GO
INSERT INTO dbo.GLB_PERFILES_USUARIOS (CD_CODIGO_PERFIL, DS_NOMBRE_PERFIL, CD_ESTADO_PERFIL, USUA_CREA, FECH_CREA) VALUES (@rol, @descripcion, 'A', 1, GETDATE())
GO" SelectCommand="SELECT id_rol, rol, descripcion, estado FROM dbo.CONF_ROL WHERE NOT(id_rol=1) ORDER BY rol
" UpdateCommand="UPDATE dbo.CONF_ROL SET rol=@rol, estado=@estado WHERE id_rol=@id_rol
GO
UPDATE dbo.GLB_PERFILES_USUARIOS SET CD_CODIGO_PERFIL = @rol, DS_NOMBRE_PERFIL=@descripcion, USUA_ACTU=1, FECH_ACTU=GETDATE() WHERE CD_CODIGO_PERFIL=@rol)
GO">
        <InsertParameters>
                    ...
                    <dx:ContentControl runat="server">
                        <dx:ASPxGridView ID="ASPxGridRoles" ClientInstanceName="ASPxGridRoles" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataRoles" KeyFieldName="id_rol">
                            <Columns>
                                ...
                                <dx:GridViewDataComboBoxColumn Caption="Estado" FieldName="estado" ShowInCustomizationForm="True" VisibleIndex="4">
