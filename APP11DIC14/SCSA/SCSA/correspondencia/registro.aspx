                                ...
                                <td colspan="3">
                                    <dx:ASPxGridView ID="GridCorrespondencia" ClientInstanceName="GridCorrespondencia" runat="server" AutoGenerateColumns="False" EnableTheming="True" Theme="DevEx" DataSourceID="SqlDataSource1" KeyFieldName="CD_AGENDA" >
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="CD_AGENDA" ShowInCustomizationForm="True" VisibleIndex="0" Visible="False">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataCheckColumn Name="Select" ShowInCustomizationForm="False" VisibleIndex="2">
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="TIPO_C" ShowInCustomizationForm="True" VisibleIndex="3" Caption="Tipo">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataDateColumn FieldName="FECHA_RECEPCION" ShowInCustomizationForm="True" VisibleIndex="4" Caption="Fecha de recepción">
                                            </dx:GridViewDataDateColumn>
                                            <dx:GridViewDataTextColumn Caption="Concepto" FieldName="CONCEPTO" ShowInCustomizationForm="True" VisibleIndex="5">
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Orígen" FieldName="ORIGEN" ShowInCustomizationForm="True" VisibleIndex="6">
                                            </dx:GridViewDataTextColumn>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SCSA %>" SelectCommand="SELECT * FROM [TMP_CORRESPONDENCIA] ORDER BY FECHA_REGISTRO DESC, CD_AGENDA DESC" DeleteCommand="DELETE FROM dbo.AGD_PUNTOS_AGENDA WHERE CD_PUNTO_AGENDA=@CD_AGENDA

 DELETE FROM dbo.TMP_CORRESPONDENCIA WHERE CD_AGENDA=@CD_AGENDA
">
                                        <DeleteParameters>
                                        ...
                                        <div id="form_reg" style="border-style: solid; border-width: 1px;">
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td rowspan="2">
                                                        <div id="radios">
                                                        <dx:ASPxRadioButtonList ID="RdTipo" runat="server" style="text-align: right">
                                                            <Items>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxComboBox ID="ComboSolicitantes" runat="server" ValueField="CODIGO"  ValueType="System.String" Width="95%" DataSourceID="SQLDS_Solicitantes">
                                                             <Columns>
