...
/// <summary>
/// Descripción breve de manto_convocatoria
/// </summary>
public class manto_convocatoria
{
	public static void nuevo(string accion, int cod_convocatoria, string referencia, int tipo_sesion, int estado_sesion, string fecha_sesion, string hora_sesion, int usuario, string fecha_registro)
	{
